...
use Mydybox\Rule_Engine\Rule_Engine;
use Mydybox\Rule_Engine\Rule;
...
$engine->register_condition( new Mydybox\Rule_Engine\Conditions\Cart_Total() );
$engine->register_condition( new Mydybox\Rule_Engine\Conditions\Max_Qty() );
$engine->register_condition( new Mydybox\Rule_Engine\Conditions\Address() );
$engine->register_condition( new Mydybox\Rule_Engine\Conditions\Product() );
$engine->register_condition( new Mydybox\Rule_Engine\Conditions\Category() );
$engine->register_action( new Mydybox\Rule_Engine\Actions\Hide_Payment() );
$engine->register_action( new Mydybox\Rule_Engine\Actions\Hide_Shipping() );
$engine->register_action( new Mydybox\Rule_Engine\Actions\Block_Checkout() );

// --- T01: Cart_Total Condition -----------------------------------------------

test_section( 'T01: Cart_Total Condition' );

$cond = new Mydybox\Rule_Engine\Conditions\Cart_Total();
...
$addr_cond  = new Mydybox\Rule_Engine\Conditions\Address();
...
$cond_def = new Mydybox\Rule_Engine\Conditions\Cart_Total();
